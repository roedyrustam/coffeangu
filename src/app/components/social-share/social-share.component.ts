...
export class SocialShareComponent {
  ...
  shareWhatsApp() {
    const waUrl = `https://wa.me/?text=${encodeURIComponent(this.text + ' ' + this.url)}`;
    window.open(waUrl, '_blank');
  }

  shareTwitter() {
    const twUrl = `https://twitter.com/intent/tweet?text=${encodeURIComponent(this.text)}&url=${encodeURIComponent(this.url)}`;
  ...
  shareLinkedIn() {
    const lnUrl = `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(this.url)}`;
